            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                ...
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="?page=returPenjualan">
                            <i class="fas fa-refresh"></i>Retur Penjualan</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="?page=piutang">
                            <i class="fas fa-upload"></i>Piutang Dagang</a>
                        </li>
                    </ul>
                </nav>
            </div>
			...
			<?php 
				...
				switch($page){
                    ...
                    case 'struk':
                        ...
                        case 'returPenjualan':
                            include "kasir/returPenjualan.php";
                            break;
                            case 'pelanggan':
                                include "kasir/pelanggan.php";
                                break;
                                case 'piutang':
                                    include "kasir/piutang.php";
                                    break;
					default:
						$page = "dashboard";
