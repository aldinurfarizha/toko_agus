            			...
            			<form method="post">
            				...
            				<div class="card-body">
								...
								<?php if (isset($_POST['dateAwal'])): ?>
									<a  target="_blank" href="manager/BarangPeriodePrint.php?dateAwal=<?php echo $param ?>&dateAkhir=<?php echo $param1 ?>"  class="btn btn-primary"><i class="fa fa-print"></i> Cetak</a>
								<?php endif ?>
								<br><br>
