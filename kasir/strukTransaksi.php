            	...
            	<div class="col-md-8">
            		<div class="card">
            			<div class="card-header">
							...
							<p>Desa Pajawanlor</p>
							<br>===Telp. 0896-4919-7669===</br></center>
            			</div>
            			<div class="card-body">
            				<div class="row">
				                  <div class="col-sm-6">Kasir  : Pipit Lestari </div>
				                  <div class="col-sm-6">
				            ...
				            <table class="table table-striped table-bordered" width="40%">
								...
								<tr>
									...
									<td><?php echo "Rp.".number_format($bayar['bayar']).",-" ?></td>
								</tr>
								<tr>
									<td colspan="2"></td>
									<td colspan="2">Kembalian</td>
									<td><?php echo "Rp.".number_format($kem['kembalian']).",-" ?></td>
								</tr>
							</table>
							<br>
